...
class NodoGrafo
{
	private:
		...
		ListaDoble<NodoGrafoParalelo<T>>* paralelo;
		bool esElPrimeroDeLaLista;
		bool esParalelo;
	public:
		NodoGrafo(T dato);
		T obtenerDato();
		...
		ListaDoble<NodoGrafoParalelo<T>>*obtenerParalelo();
		...
		bool tieneParalelo();
		bool esNodoParalelo();
		void indicarQueEsElPrimero();
		void indicarEsNodoParalelo();
		bool esElPrimeroenLalista();
...
NodoGrafo<T>::NodoGrafo(T dato)
{
	...
	this->anterior=NULL;
	this->paralelo=NULL;
	this->esElPrimeroDeLaLista =false;
	this->esParalelo=false;
}

template<class T>
bool NodoGrafo<T>::esNodoParalelo(){

	return esParalelo;
}
template<class T>
void NodoGrafo<T>::indicarEsNodoParalelo(){

	this->esParalelo = true;
}
template<class T>
...
template<class T>
ListaDoble<NodoGrafoParalelo<T>>* NodoGrafo<T>::obtenerParalelo()
{
...
template<class T>
void NodoGrafo<T>::indicarQueEsElPrimero(){

	this->esElPrimeroDeLaLista =true;
