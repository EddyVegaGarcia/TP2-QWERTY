...
Porque de la primera forma siempre se revive al jugador A (hace una sola vez lo que está dentro del do while, xq está pisando el "alias")
Pero de la segunda forma tampoco funciona (se queda eternamente pensando y el debugger pe dice que siempre queda 'estancado' en el último jugador y no vuelve a empezar por el jugador A (no entiendo por qué si ese cursor2 es copipaste del cursor que sí funciona) (tengo sueño, no sé)).
